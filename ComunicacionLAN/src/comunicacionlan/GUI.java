...
public class GUI extends javax.swing.JFrame {
	...
	private void botonConectarActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	motoman.abrirPuerto();
    	//new ServidorNIO().run();
    	//motoman = new ComunicacionLAN(0, 0, 0, 0, 0, 0, 0);
    	//motoman.start();
    	//motoman.pulsS = 0;
    	motoman.enviarPosicion(0,0,0,0,0,0);
    	new ServidorNIO().run();
    ...
    private void botonCerrarActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    	motoman.cerrarPuerto();
    	//motoman = new ComunicacionLAN(2, 0, 0, 0, 0, 0, 0);
    	//motoman.start();
...
//        ComunicacionLAN prueba = new ComunicacionLAN();
//        prueba.abrirPuerto();
//        prueba.enviarPosicion(0,0,0,0,0,0);
//        prueba.cerrarPuerto();
...
//                                    motoman = new ComunicacionLAN(1, pulsS, pulsL, pulsU, pulsR, pulsB, pulsT);
//                                    motoman.enviarPosicion();
//                                    //motoman.start();                                    
