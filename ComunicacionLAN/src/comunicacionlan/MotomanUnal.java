...
public class MotomanUnal extends PApplet {
	...
	OBJModel base, ejeS, ejeL, ejeU, ejeR, ejeB, ejeTOp, ejeTCl, baseMesaRobot;//, mesaPC, mesaTorno, baseMesaRobot;
	...
	ComunicacionLAN robotmotoman = new ComunicacionLAN();
...
//		
	...
	public void teach() throws IOException{
		...
		vg.changeS((int)(valorEjes[0] * 14353 / 10));
		vg.changeL((int)(valorEjes[1] * 13003 / 10));
		vg.changeU((int)(valorEjes[2] * 13767 / 10));
		vg.changeR((int)(valorEjes[3] * 5689 / 10));
		vg.changeB((int)(valorEjes[4] * 8239 / 10));
		vg.changeT((int)(valorEjes[5] * 4255 / 10));
		
		vg.changeMover(true);
		
		//robotmotoman.enviarPosicion((int)(valorEjes[0] * 14353 / 10), (int)(valorEjes[1] * 13003 / 10), (int)(valorEjes[2] * 13767 / 10), 
				//(int)(valorEjes[3] * 5689 / 10), (int)(valorEjes[4] * 8239 / 10), (int)(valorEjes[5] * 4255 / 10));
	}

	public void tarea() throws IOException{
		//robotmotoman.crearTarea();	
	}
