...
public class Cinematica {
	...
	public void solve(float t3Ant){
		
		u3Ant = (float) (Math.tan(t3Ant * Math.PI / 360));
//		System.out.println("t3Ant: " + t3Ant + " u3Ant: " + u3Ant);
//		System.out.println("x: " + x + " y: " + y + " z: " + z);
		
		int i = 0;
		float m, u3, inicio = 0, h = 0.02f;
		float u3_0 = u3Ant - h;
		u3 = u3Ant;
		...
		d = new Double(u3);
		if(d.isNaN() || d.isInfinite()) System.err.println("No encontro solucion real");
...
//		System.out.println("Todas:" + raices[0] + " " + raices[1] + " " + raices[2] + " " + raices[3]);
		
		u3 = raices[0];
		u3Temp = Math.abs(raices[0] - u3Ant);
		
		for(int ind = 0; ind < 4; ind++){
			if(Math.abs(raices[ind] - u3Ant) < u3Temp){
				u3 = raices[ind];
				u3Temp = Math.abs(raices[ind] - u3Ant);
			}
		}
//		System.out.println("La que escoge: " + u3);

		d = new Double(u3);
		if(d.isNaN() || d.isInfinite()) System.out.println("No encontro solucion real");
		else{
...
//		System.out.println(theta[0] + " " + theta[1] + " " + theta[2] + "\n");
		return theta;
	}
